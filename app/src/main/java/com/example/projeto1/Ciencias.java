...
public class Ciencias extends AppCompatActivity {
    ...
    private void readCSV() {
        try {
            InputStream inputStream = getResources().openRawResource(R.raw.questionscc); // arquivo CSV deve estar em res/raw
    ...
    private void checkAnswer(String selectedAnswer) {
        ...
        if (currentQuestion < questionsList.size() - 1) {
            ...
            Toast.makeText(Ciencias.this, "Completaste a tarefa!", Toast.LENGTH_SHORT).show();
